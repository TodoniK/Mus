...
class TourTest {
  ...
  void devrait_attribuer_les_bonus_au_joueur_ayant_la_meilleure_main_pour_chaque_phase() {
    var equipe1 = new Equipe(1,unJoueurFaisantChoix(new Mintza(), new Paso(), new Paso()),unJoueurFaisantChoix(new Paso(), new Paso()));
    var equipe2 = new Equipe(2,unJoueurFaisantChoix(new Paso(), new Paso()),unJoueurFaisantChoix(new Paso(), new Paso()));
    var opposants = new Opposants(equipe1, equipe2);
    var score = new Manche.Score(opposants);
